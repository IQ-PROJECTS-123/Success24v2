...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <img src="https://success24.in/img/iq-india2.jpeg"
            ...
            alt="HTML CSS JavaScript Training" />
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="backdrop-blur-md bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
                ...
                <h2 class="text-xl md:text-2xl font-bold mb-4
                       ...
                       bg-clip-text text-transparent">2026 Frontend Web Development Program
                </h2>
                ...
                <h1 class="text-5xl md:text-7xl font-black mb-6
                       bg-gradient-to-r from-yellow-400 to-blue-500
                       bg-clip-text text-transparent">HTML, CSS & JavaScript Training
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold">
                    Responsive Design, Modern CSS, JavaScript ES6+ & Real-World Projects
                </p>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become a Frontend Devloper?
            </h2>
