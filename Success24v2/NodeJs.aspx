<%@ Page Title="" Language="C#" MasterPageFile="~/24.Master" AutoEventWireup="true" CodeBehind="NodeJs.aspx.cs" Inherits="Success24v2.NodeJs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="relative overflow-hidden h-screen flex items-center justify-center">
        <img src="https://success24.in/img/iq-india2.jpeg"
            ...
            alt="Node.js Development Training" />
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="hero-text-glow">
                <h2 class="font-bold text-xl md:text-2xl mb-4 scroll-fade-left">
                    <span class="gradient-blue-yellow">2026 Backend Development Program</span>
                </h2>

                <div class="hero-line mx-auto mb-6"></div>

                <h1 class="font-black text-5xl md:text-7xl mb-6 scroll-scale">
                    <span class="gradient-yellow-blue">Node.js Development Training
                    </span>
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold scroll-fade-right">
                    Build Scalable Backend APIs with Node.js & Express
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Start Your Backend Developer Career
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2 counter" data-target="60">0</h3>
                    <p class="text-sm text-gray-400">Backend Projects</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">REST</h3>
                    <p class="text-sm text-gray-400">API Development</p>
                </div>
                <div class="scroll-scale">
                ...
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Cloud</h3>
                    <p class="text-sm text-gray-400">Deployment Ready</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Node.js & Backend Development
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Become a Professional Node.js Developer
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Node.js is the backbone of modern backend development.
                        This course covers Node.js, Express, MongoDB, REST APIs,
                        authentication, security, and deployment with real-world projects.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/nodejs-dev.jpg"
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Node.js Development Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    From JavaScript fundamentals to scalable backend systems.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">JavaScript & Node Basics</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>JavaScript ES6+</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Node.js Architecture</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>NPM & Modules</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Async Programming</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Backend APIs</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Express.js</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>RESTful APIs</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>JWT Authentication</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>API Security</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Database & Deployment</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>MongoDB & Mongoose</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Cloud Deployment</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Docker Basics</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Live Backend Projects</li>
                    </ul>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid lg:grid-cols-12 gap-8">
                    ...
                    <div class="p-8 bg-white rounded-2xl border-2 border-gray-200 shadow-lg h-full hover-lift">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <h6 class="font-bold">Live Backend Projects</h6>
                                    <p class="text-sm text-gray-600">APIs & Microservices</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Node.js questions</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Backend portfolio</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                ...
                <div class="lg:col-span-5">
                    <div class="p-8 rounded-2xl text-center text-white shadow-2xl h-full bg-gradient-to-br from-green-600 to-emerald-400 hover-lift">
                        <h6 class="uppercase font-bold text-sm mb-3">Expected Package</h6>
                        <h1 class="text-6xl font-bold mb-3">6 – 14 LPA</h1>
                        <p class="opacity-90 mb-6">Based on backend expertise</p>
