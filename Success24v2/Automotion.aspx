...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    ...
                    <p class="text-sm text-gray-400">Hands-on Automation</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">20+</h3>
                    <p class="text-sm text-gray-400">Real Test Scenarios</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Live</h3>
                    <p class="text-sm text-gray-400">Framework Projects</p>
                </div>
                <div class="scroll-scale">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    ...
                    <p class="text-gray-600 text-lg leading-relaxed">
                        ...
                        This course trains you in Selenium WebDriver, Java, TestNG,
                        Maven, Git, and real-time automation frameworks.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://images.unsplash.com/photo-1518770660439-4636190af475"
                        class="w-full rounded-2xl shadow-2xl hover-lift" alt="Testing" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Automation Testing Roadmap</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 transition-all hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Manual Testing Basics</h4>
                    <ul class="text-gray-600 space-y-2">
                        ...
                        <li class="flex items-start gap-2">
                            <i class="fas fa-check-circle text-orange-500 mt-1"></i>
                            <span>Test Case Writing</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-check-circle text-orange-500 mt-1"></i>
                            <span>Defect Life Cycle</span>
                        </li>
                        <li class="flex items-start gap-2">
                            <i class="fas fa-check-circle text-orange-500 mt-1"></i>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 transition-all hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Selenium Automation</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex items-start gap-2">
                            <i class="fas fa-check-circle text-orange-500 mt-1"></i>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 transition-all hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Framework & CI/CD</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex items-start gap-2">
                            <i class="fas fa-check-circle text-orange-500 mt-1"></i>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become an Automation Tester?</h2>
            <p class="text-xl mb-8 opacity-90">Join our comprehensive automation testing program today</p>
