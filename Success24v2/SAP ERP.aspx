<%@ Page Title="" Language="C#" MasterPageFile="~/24.Master" AutoEventWireup="true" CodeBehind="SAP ERP.aspx.cs" Inherits="Success24v2.SAP_ERP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="relative overflow-hidden h-screen flex items-center justify-center">
        <img src="https://success24.in/img/iq-india2.jpeg"
            ...
            alt="SAP ERP Development Training" />
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="hero-text-glow">
                <h2 class="font-bold text-xl md:text-2xl mb-4 scroll-fade-left">
                    <span class="gradient-blue-yellow">2026 Enterprise Career Program</span>
                </h2>

                <div class="hero-line mx-auto mb-6"></div>

                <h1 class="font-black text-5xl md:text-7xl mb-6 scroll-scale">
                    <span class="gradient-yellow-blue">SAP ERP + Development
                    </span>
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold scroll-fade-right">
                    Master SAP Functional + Technical Modules with Real Projects
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Build Your SAP Consultant Career
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">SAP</h3>
                    <p class="text-sm text-gray-400">S/4HANA</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">ABAP</h3>
                    <p class="text-sm text-gray-400">Development</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">FI / MM</h3>
                    <p class="text-sm text-gray-400">Functional</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">100%</h3>
                    <p class="text-sm text-gray-400">Enterprise Ready</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">SAP ERP & Development
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Become an SAP ERP Consultant & Developer
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        SAP ERP powers the world’s largest enterprises.
                        This program covers SAP S/4HANA, core functional modules
                        (FI, CO, MM, SD) along with ABAP development,
                        reports, enhancements, and real-time business scenarios.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/sap-training.jpg"
                        class="w-full rounded-2xl shadow-2xl hover-lift"
                        alt="SAP ERP Training" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">SAP ERP + Development Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    Functional + Technical SAP skills from scratch.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">SAP ERP Fundamentals</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>SAP Architecture</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>S/4HANA Overview</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Business Processes</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>System Navigation</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Functional Modules</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>FI & CO</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>MM & SD</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Configuration</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Real Business Scenarios</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">ABAP Development</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>ABAP Programming</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Reports & Forms</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>User Exits & BADI</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Live SAP Project</li>
                    </ul>
                </div>
            ...
            <div class="grid lg:grid-cols-12 gap-8">
                    ...
                    <div class="p-8 bg-white rounded-2xl border-2 border-gray-200 shadow-lg h-full hover-lift">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="flex gap-3">
                                <i class="fas fa-project-diagram text-2xl text-orange-500 mt-1"></i>
                                <div>
                                    <h6 class="font-bold">Live SAP Projects</h6>
                                    <p class="text-sm text-gray-600">Enterprise scenarios</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Functional & ABAP</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                <i class="fas fa-file-alt text-2xl text-orange-500 mt-1"></i>
                                <div>
                                    <h6 class="font-bold">Resume & SAP Profile</h6>
                                    <p class="text-sm text-gray-600">Consultant focused</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                ...
                <div class="lg:col-span-5">
                    <div class="p-8 rounded-2xl text-center text-white shadow-2xl h-full bg-gradient-to-br from-blue-600 to-indigo-400 hover-lift">
                        ...
                        <h1 class="text-6xl font-bold mb-3">6 – 18 LPA</h1>
                        <p class="opacity-90 mb-6">Based on module & experience</p>
