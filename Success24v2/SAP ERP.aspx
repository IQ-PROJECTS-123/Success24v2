        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
                ...
                <h2 class="text-xl md:text-2xl font-bold mb-4
                       ...
                       bg-clip-text text-transparent">2026 Enterprise Resource Planning Program
                </h2>
                ...
                <h1 class="text-5xl md:text-7xl font-black mb-6
                       bg-gradient-to-r from-yellow-400 to-blue-500
                       bg-clip-text text-transparent">SAP ERP Training
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold">
                    SAP FICO, MM, SD, HCM, Real-Time Business Scenarios & Live Projects
                </p>
