...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
                ...
                <h1 class="text-5xl md:text-7xl font-black mb-6
                       bg-gradient-to-r from-yellow-400 to-blue-500
                       bg-clip-text text-transparent">Linux / Administration Training
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold">
                    UNIX / Linux SHELL,UNIX / Linux SHELL,Red Hat Openstack, Statistics & Real-Time Projects
                </p>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Start Your Linux Admin Career Today
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    ...
                    <p class="text-sm text-gray-400">Hands-on Linux Labs</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">RHCSA</h3>
                    <p class="text-sm text-gray-400">Admin Concepts</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Servers</h3>
                    <p class="text-sm text-gray-400">Production Setup</p>
                </div>
                <div class="scroll-scale">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Linux System Administration
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Become a Professional Linux Administrator
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Linux powers servers, cloud platforms, and enterprise systems worldwide.
                        This course covers Linux installation, user management, file systems,
                        networking, security, shell scripting, and real-time server administration.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/linux-admin.jpg"
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Linux Administration Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    From Linux basics to advanced server administration.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Linux Fundamentals</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Linux Architecture</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>File & Directory Management</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>User & Group Management</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Permissions & Ownership</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Server Administration</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Package Management</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Process Management</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Networking & Firewall</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Disk & LVM Management</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Advanced Linux</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Shell Scripting</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Server Security</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Backup & Monitoring</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Live Server Projects</li>
                    </ul>
                </div>
            ...
            <div class="grid lg:grid-cols-12 gap-8">
                    ...
                    <div class="p-8 bg-white rounded-2xl border-2 border-gray-200 shadow-lg h-full hover-lift">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <h6 class="font-bold">Live Linux Servers</h6>
                                    <p class="text-sm text-gray-600">Real production setup</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Admin & troubleshooting</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Linux admin profile</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                ...
                <div class="lg:col-span-5">
                    <div class="p-8 rounded-2xl text-center text-white shadow-2xl h-full bg-gradient-to-br from-blue-600 to-cyan-400 hover-lift">
                        ...
                        <p class="opacity-90 mb-6">Based on Linux administration skills</p>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become a Linux Administration Devloper?
            </h2>
            <p class="text-xl mb-8 opacity-90">
                Learn Linux Administration with real-world projects
            </p>
