<%@ Page Title="" Language="C#" MasterPageFile="~/24.Master" AutoEventWireup="true" CodeBehind="Big data Hadoop.aspx.cs" Inherits="Success24v2.Big_data_Hadoop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="relative overflow-hidden h-screen flex items-center justify-center">
        <img src="https://success24.in/img/iq-india2.jpeg"
            class="absolute inset-0 w-full h-full object-cover" alt="Big Data Hadoop Training" />
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="hero-text-glow">
                <h2 class="font-bold text-xl md:text-2xl mb-4 scroll-fade-left">
                    <span class="gradient-blue-yellow">2026 Big Data Analytics Program</span>
                </h2>

                <div class="hero-line mx-auto mb-6"></div>

                <h1 class="font-black text-5xl md:text-7xl mb-6 scroll-scale">
                    <span class="gradient-yellow-blue">Big Data Hadoop Training</span>
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold scroll-fade-right">
                    Master Hadoop, Spark, Hive & Real-Time Big Data Projects
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Start Your Big Data Career Today
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    ...
                    <p class="text-sm text-gray-400">Hands-on Hadoop Labs</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">35+</h3>
                    <p class="text-sm text-gray-400">Big Data Tools</p>
                </div>
                <div class="scroll-scale">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Big Data & Hadoop Ecosystem
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Build a Career in Big Data Engineering
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Big Data professionals are in high demand across industries.
                    This course covers Hadoop, HDFS, YARN, Spark, Hive, HBase,
                    Kafka and real-time data processing use cases.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://images.unsplash.com/photo-1518770660439-4636190af475"
                        class="w-full rounded-2xl shadow-2xl hover-lift" alt="Big Data Hadoop" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Big Data Hadoop Roadmap</h2>
                <p class="text-gray-600 text-lg">
                    From Hadoop basics to advanced Spark processing.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 transition-all hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Big Data Fundamentals</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Big Data Concepts</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Hadoop Architecture</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>HDFS & YARN</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>MapReduce Basics</span></li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 transition-all hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Hadoop Ecosystem</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Hive & Pig</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>HBase</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Sqoop & Flume</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Kafka Basics</span></li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 transition-all hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Spark & Real-Time Processing</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Apache Spark</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Spark SQL & Streaming</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>MLlib Basics</span></li>
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i><span>Real-Time Big Data Projects</span></li>
                    </ul>
                </div>
    ...
    <section class="py-16 bg-slate-50 border-t">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold text-gray-900 mb-4">Become a Big Data Hadoop Engineer
                </h2>
                <p class="text-lg text-gray-600">
                    Industry-ready Big Data skills with placement support.
                </p>
            </div>
            ...
            <div class="grid lg:grid-cols-12 gap-8">
                    ...
                    <div class="p-8 bg-white rounded-2xl border-2 border-gray-200 shadow-lg h-full scroll-fade-left hover-lift">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <h6 class="font-bold text-lg mb-1">Live Big Data Projects</h6>
                                    <p class="text-sm text-gray-600">Hadoop & Spark use cases</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Big Data & Spark questions</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Big Data engineer profile</p>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-5">
                    <div class="p-8 rounded-2xl text-center text-white shadow-2xl h-full bg-gradient-to-br from-blue-600 to-cyan-400 scroll-fade-right hover-lift">
                        ...
                        <h1 class="text-6xl font-bold mb-3">6 – 15 LPA</h1>
                        <p class="text-lg opacity-90 mb-6">Based on Big Data expertise</p>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become a Big Data Engineer?
            </h2>
            <p class="text-xl mb-8 opacity-90">
                Join our Big Data Hadoop training program today
            </p>
