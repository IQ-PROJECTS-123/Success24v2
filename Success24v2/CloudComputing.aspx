<%@ Page Title="" Language="C#" MasterPageFile="~/24.Master" AutoEventWireup="true"
    CodeBehind="CloudComputing.aspx.cs" Inherits="Success24v2.CloudComputing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="relative overflow-hidden h-screen flex items-center justify-center">
        <img src="https://success24.in/img/iq-india2.jpeg"
            class="absolute inset-0 w-full h-full object-cover" alt="Cloud Computing Training" />
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="hero-text-glow">
                <h2 class="font-bold text-xl md:text-2xl mb-4 scroll-fade-left">
                    <span class="gradient-blue-yellow">2026 Cloud Computing Program</span>
                </h2>

                <div class="hero-line mx-auto mb-6"></div>

                <h1 class="font-black text-5xl md:text-7xl mb-6 scroll-scale">
                    <span class="gradient-yellow-blue">Cloud Computing Training</span>
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold scroll-fade-right">
                    Master AWS, Azure & Google Cloud with Real-World Projects
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Start Your Cloud Career Today
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2 counter" data-target="120">0</h3>
                    <p class="text-sm text-gray-400">Hands-on Cloud Labs</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">AWS • Azure</h3>
                    <p class="text-sm text-gray-400">Multi-Cloud Platforms</p>
                </div>
                <div class="scroll-scale">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Cloud Computing & DevOps
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Build a Career as a Cloud Engineer
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Cloud Computing professionals are in massive demand globally.
                        This course covers AWS, Microsoft Azure, Google Cloud, cloud
                        architecture, deployment, automation, security and DevOps
                        integration with real-world use cases.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/cloud-computing-training.jpg"
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Cloud Computing Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    From cloud fundamentals to advanced architecture.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Cloud Fundamentals</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Cloud Concepts & Models</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>IaaS, PaaS, SaaS</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Virtualization</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Cloud Networking</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">AWS & Azure</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>EC2, S3, VPC</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Azure VM & Storage</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>IAM & Security</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Monitoring & Scaling</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">DevOps & Architecture</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>CI/CD Pipelines</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Docker & Kubernetes</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Cloud Security</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Live Cloud Projects</li>
                    </ul>
                </div>
