...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <img src="https://success24.in/img/iq-india2.jpeg"
            ...
            alt="Hadoop Development & Administration" />
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="backdrop-blur-md bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
                ...
                <h1 class="text-5xl md:text-7xl font-black mb-6
                       bg-gradient-to-r from-yellow-400 to-blue-500
                       bg-clip-text text-transparent">Hadoop Development & Administration Training
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold">
                    HDFS, YARN, MapReduce, Hive, Spark & Real-Time Big Data Projects
                </p>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Build Your Career in Big Data
        </h2>
    ...
    <section class="bg-slate-900 border-t border-b border-slate-700">
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                ...
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">HDFS</h3>
                    <p class="text-sm text-gray-400">Distributed Storage</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Spark</h3>
                    <p class="text-sm text-gray-400">Big Data Processing</p>
                </div>
                <div class="scroll-scale">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Big Data Engineering
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Hadoop Developer & Administrator Career Path
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Hadoop professionals manage and process massive datasets.
                        This course covers Hadoop development and administration
                        including cluster setup, HDFS, YARN, Hive, Spark,
                        performance tuning, security and real-time big data projects.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/hadoop-training.jpg"
                        class="w-full rounded-2xl shadow-2xl hover-lift"
                        alt="Hadoop Development & Administration Training" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Hadoop Development & Admin Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    From Hadoop basics to enterprise cluster administration.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Hadoop Fundamentals</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Big Data Concepts</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Hadoop Architecture</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>HDFS & Replication</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>YARN Overview</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Hadoop Development</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>MapReduce Programming</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Hive & Pig</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Spark Core & SQL</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Data Ingestion</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Administration & Security</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Cluster Installation</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Monitoring & Tuning</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Hadoop Security</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Live Big Data Projects</li>
                    </ul>
                </div>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become a Hadoop Developer?
            </h2>
            <p class="text-xl mb-8 opacity-90">
                Learn Hadoop Developer with real-world projects
            </p>
