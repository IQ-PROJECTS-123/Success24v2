...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .card-img-wrap img {
            width: 100%;
            height: 100%;
            object-fit: cover; /* Key property for alignment */
        }
    </style>
</asp:Content>
                ...
                <div class="container">
                    <div class="row g-4">
                        <div class="col-12 col-sm-6 col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="counter bg-white p-4 rounded shadow-sm text-center h-100">
                                ...
                                <div class="counter-content d-flex align-items-center justify-content-center mt-4">
                                    <div class="text-3xl font-bold display-4 text-primary counter-up">
                                        <asp:Literal runat="server" ID="_LiteralSuccess" />
                                    </div>
                        ...
                        <div class="col-12 col-sm-6 col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="counter bg-white p-4 rounded shadow-sm text-center h-100">
                                ...
                                <div class="counter-content d-flex align-items-center justify-content-center mt-4">
                                    <div class="text-3xl font-bold display-4 text-primary counter-up">10</div>
                                    <h4 class="text-secondary mb-0" style="font-weight: 600; font-size: 25px;">+</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="counter bg-white p-4 rounded shadow-sm text-center h-100">
                                ...
                                <div class="counter-content d-flex align-items-center justify-content-center mt-4">
                                    <div class="text-3xl font-bold display-4 text-primary counter-up">15</div>
                                    <h4 class="text-secondary mb-0" style="font-weight: 600; font-size: 25px;">+</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-md-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                            <div class="counter bg-white p-4 rounded shadow-sm text-center h-100">
                                ...
                                <div class="counter-content d-flex align-items-center justify-content-center mt-4">
                                    <div class="text-3xl font-bold display-4 text-primary counter-up">
                                        <asp:Literal runat="server" ID="_LiteralPrac" />
                                    </div>
                                    <h4 class="text-secondary mb-0" style="font-weight: 600; font-size: 25px;">+</h4>
                                </div>
                            </div>
