<%@ Page Title="" Language="C#" MasterPageFile="~/24.Master" AutoEventWireup="true" CodeBehind="Java.aspx.cs" Inherits="Success24v2.Java" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <section class="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <div class="backdrop-blur-md bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
            ...
            <h1 class="text-5xl md:text-7xl font-black mb-6
                       bg-gradient-to-r from-yellow-400 to-blue-500
                       bg-clip-text text-transparent">Java Technologeis Training
            </h1>

            <p class="text-white text-xl md:text-2xl font-semibold">
                Java Full Stack Development Training, Statistics & Real-Time Projects
            </p>
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Start Your Java Developer Career Today
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                ...
                <div class="scroll-scale">
                    ...
                    <p class="text-sm text-gray-400">Strong Fundamentals</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Spring</h3>
                    <p class="text-sm text-gray-400">Boot & Microservices</p>
                </div>
                <div class="scroll-scale">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Java Development Technology
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Become a Professional Java Developer
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        Java is one of the most in-demand programming languages worldwide.
                        This course covers Core Java, Advanced Java, JDBC, Servlets,
                        Spring, Spring Boot, REST APIs, and real-time enterprise projects.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/java-dev.jpg"
                        class="w-full rounded-2xl shadow-2xl hover-lift"
                        alt="Java Developer Training" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">Java Developer Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    From Java basics to enterprise-level applications.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Core Java</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>OOP Concepts</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Collections Framework</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Exception Handling</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Multithreading</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Advanced Java</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>JDBC</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Servlets & JSP</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>MVC Architecture</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Web Applications</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Spring & Microservices</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Spring Core & MVC</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Spring Boot</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>REST APIs</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Real-Time Projects</li>
                    </ul>
                </div>
            ...
            <div class="grid lg:grid-cols-12 gap-8">
                    ...
                    <div class="p-8 bg-white rounded-2xl border-2 border-gray-200 shadow-lg h-full hover-lift">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <h6 class="font-bold">Live Java Projects</h6>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Core & Spring questions</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Java developer profile</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                ...
                <div class="lg:col-span-5">
                    <div class="p-8 rounded-2xl text-center text-white shadow-2xl h-full bg-gradient-to-br from-blue-600 to-cyan-400 hover-lift">
                        ...
                        <h1 class="text-6xl font-bold mb-3">4 – 10 LPA</h1>
                        <p class="opacity-90 mb-6">Based on Java development skills</p>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become a Java Coder?
            </h2>
            <p class="text-xl mb-8 opacity-90">
                Learn Java Devloper with real-world projects
            </p>
