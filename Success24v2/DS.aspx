<%@ Page Title="Data Science Training" Language="C#" MasterPageFile="~/24.Master"
    AutoEventWireup="true" CodeBehind="DS.aspx.cs" Inherits="Success24v2.DS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="backdrop-blur-md bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
                ...
                <h1 class="text-5xl md:text-7xl font-black mb-6
                           bg-gradient-to-r from-yellow-400 to-blue-500
                           bg-clip-text text-transparent">Data Science Training
                </h1>
    ...
    <!-- CTA BANNER -->
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12">
        ...
        <div class="text-3xl md:text-5xl font-bold text-white">
            <a href="tel:+919555580458" class="hover:text-gray-900 transition">+91 95555 80458
            </a>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div>
                    ...
                    <p class="text-gray-400 text-sm">Hands-on Labs</p>
                </div>
                <div>
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">15+</h3>
                    <p class="text-gray-400 text-sm">ML Algorithms</p>
                </div>
                <div>
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Live</h3>
                    <p class="text-gray-400 text-sm">Industry Projects</p>
                </div>
                <div>
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Career</h3>
                    <p class="text-gray-400 text-sm">Job-Focused Training</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p class="text-gray-600 text-lg leading-relaxed">
                    ...
                    Learn Python, statistics, machine learning, deep learning,
                    data visualization and real-world analytics projects.
                </p>
            </div>

            <img src="https://success24.in/img/data-science-img.jpg"
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="absolute inset-0 flex items-center justify-center">
            <div class="max-w-7xl mx-auto px-6 w-full">
                ...
                <h2 class="text-center text-3xl md:text-4xl font-bold text-orange-400 mb-10">Live Class Data Science Training
                </h2>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white text-center">
        ...
        <div class="flex justify-center gap-4 flex-wrap">
            <a href="tel:+919555580458"
                class="bg-white text-orange-600 px-10 py-4 rounded-full font-bold text-lg hover:bg-yellow-300 transition">Call Now
            </a>
            <a href="#enroll"
                class="border-2 border-white px-10 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-orange-600 transition">Enroll Today
            </a>
        </div>
    </section>
