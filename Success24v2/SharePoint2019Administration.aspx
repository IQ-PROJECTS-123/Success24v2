...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="bg-gradient-to-r from-yellow-400 to-orange-400 text-center py-12 scroll-scale">
        <h2 class="font-extrabold text-3xl md:text-5xl mb-3 text-gray-900 uppercase">Become a SharePoint Administrator
        </h2>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">On-Prem</h3>
                    <p class="text-sm text-gray-400">SharePoint 2019</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Farm</h3>
                    <p class="text-sm text-gray-400">Administration</p>
                </div>
                <div class="scroll-scale">
                    <h3 class="text-5xl font-bold text-orange-500 mb-2">Security</h3>
                    <p class="text-sm text-gray-400">Permissions & Auth</p>
                </div>
                <div class="scroll-scale">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="scroll-fade-left">
                    <h6 class="uppercase text-orange-500 font-bold text-sm mb-3">Microsoft SharePoint Server
                    </h6>
                    <h2 class="text-4xl font-bold mb-4">Build a Career as SharePoint Administrator
                    </h2>
                    <p class="text-gray-600 text-lg leading-relaxed">
                        SharePoint 2019 administrators manage enterprise collaboration platforms.
                        This course covers installation, configuration, service applications,
                        security, backup & restore, monitoring, upgrades and real-time
                        SharePoint farm administration scenarios.
                    </p>
                </div>
                <div class="scroll-fade-right">
                    <img src="https://success24.in/img/sharepoint-admin.jpg"
                        class="w-full rounded-2xl shadow-2xl hover-lift"
                        alt="SharePoint 2019 Administration" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12 scroll-reveal">
                ...
                <h2 class="text-4xl font-bold mb-4">SharePoint 2019 Admin Roadmap
                </h2>
                <p class="text-gray-600 text-lg">
                    From installation to enterprise-level administration.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">SharePoint Fundamentals</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>SharePoint Architecture</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>2019 New Features</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Farm Components</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Admin Center</li>
                    </ul>
                </div>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Installation & Configuration</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Prerequisites Setup</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Farm Configuration</li>
                ...
                <div class="p-6 rounded-2xl border-2 border-gray-200 hover:border-orange-500 hover-lift scroll-reveal bg-white">
                    ...
                    <h4 class="text-2xl font-bold mb-4">Administration & Maintenance</h4>
                    <ul class="text-gray-600 space-y-2">
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Backup & Restore</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Monitoring & Health</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Security & Permissions</li>
                        <li class="flex gap-2"><i class="fas fa-check-circle text-orange-500 mt-1"></i>Live Admin Scenarios</li>
                    </ul>
                </div>
            ...
            <div class="grid lg:grid-cols-12 gap-8">
                    ...
                    <div class="p-8 bg-white rounded-2xl border-2 border-gray-200 shadow-lg h-full hover-lift">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="flex gap-3">
                                ...
                                <div>
                                    <h6 class="font-bold">Live SharePoint Farm</h6>
                                    <p class="text-sm text-gray-600">Admin practice</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                <i class="fas fa-user-tie text-2xl text-orange-500 mt-1"></i>
                                <div>
                                    <h6 class="font-bold">Admin Interview Prep</h6>
                                    <p class="text-sm text-gray-600">Real questions</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                                <i class="fas fa-file-alt text-2xl text-orange-500 mt-1"></i>
                                <div>
                                    <h6 class="font-bold">Resume & Role Mapping</h6>
                                    <p class="text-sm text-gray-600">Admin focused</p>
                                </div>
                            </div>
                            <div class="flex gap-3">
                ...
                <div class="lg:col-span-5">
                    <div class="p-8 rounded-2xl text-center text-white shadow-2xl h-full bg-gradient-to-br from-blue-600 to-cyan-400 hover-lift">
                        ...
                        <p class="opacity-90 mb-6">Based on experience</p>
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full z-10">
            <h2 class="text-center text-3xl md:text-4xl font-bold text-orange-400 mb-10 scroll-reveal">Live SharePoint Lab Sessions
            </h2>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="scroll-scale">
                    <img src="https://success24.in/img/class1.jpg"
                        class="w-full rounded-xl shadow-2xl hover-lift" alt="SharePoint Session 1" />
                </div>
                <div class="scroll-scale">
                    <img src="https://success24.in/img/DS_5.jpg"
                        class="w-full rounded-xl shadow-2xl hover-lift" alt="SharePoint Session 2" />
                </div>
                <div class="scroll-scale">
                    <img src="https://success24.in/img/classds.jpg"
                        class="w-full rounded-xl shadow-2xl hover-lift" alt="SharePoint Session 3" />
                </div>
                <div class="scroll-scale">
                    <img src="https://success24.in/img/class_4.jpg"
                        class="w-full rounded-xl shadow-2xl hover-lift" alt="SharePoint Session 4" />
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            ...
            <p class="text-xl mb-8 opacity-90">
                Become a certified SharePoint Consultant with hands-on labs
            </p>
