...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-6 text-center">
            <div class="bg-slate-900/40 p-12 rounded-3xl shadow-2xl">
                ...
                <h1 class="text-5xl md:text-7xl font-black mb-6
                       bg-gradient-to-r from-yellow-400 to-blue-500
                       bg-clip-text text-transparent">Mobile Application Development
                </h1>

                <p class="text-white text-xl md:text-2xl font-semibold">
                    mobile app development, testing, and management across various platforms and frameworks, Statistics & Real-Time Projects
                </p>
    ...
    <section class="py-20 bg-gradient-to-r from-orange-500 to-red-500 text-white scroll-scale">
        <div class="max-w-4xl mx-auto px-6 text-center">
            <h2 class="text-4xl md:text-5xl font-bold mb-6">Ready to Become a Mobile Application Devloper?
            </h2>
            <p class="text-xl mb-8 opacity-90">
                Learn Data Mobile Application Devloper with real-world projects
            </p>
